...
public class MyClass {
	...
	public static void main(String... args) {
       ...
       // String dsn = args[0];
       //String dsn = "https://public:private@host:port/1";
       String dsn="http://8292bf61d620417282e68a72ae03154a:e3908e05ad874b24b7a168992bfa3577@localhost:8081/1?async=false";
        Sentry.init(dsn);
        ...
        */
        ...
        sentry.sendMessage("Hello World!");
    ...
    void logWithStaticAPI() {
        ...
        Sentry.getContext().setUser(
            new UserBuilder().setEmail("sradhanjali@infimonk.com").build()
        );
    ...
    void logWithInstanceAPI() {
        ...
        // Set the user in the current context.
        context.setUser(new UserBuilder().setEmail("sradhanjali@infimonk.com").build());
